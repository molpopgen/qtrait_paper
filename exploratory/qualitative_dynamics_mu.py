...
#This script varies mu with VS=1 and sigma_mu = sqrt(0.05)
...
popstats_output = pd.HDFStore('popstats_vary_mu.h5','w',complevel=6,complib='zlib')
sfs_output = pd.HDFStore('sfs_vary_mu.h5','w',complevel=6,complib='zlib')
