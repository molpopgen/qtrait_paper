...
out=pd.HDFStore('tenLocusPopgenLociWithFixations.h5','w',complevel=6,complib='zlib')
...
x=pd.read_hdf('tenLocusPopgenLociWithFixations.h5')
xg=x.groupby(['opt','mu']).mean().reset_index()
xg.to_hdf('tenLocusPopgenMeansLociWithFixations.h5','means',complevel=6,complib='zlib')
