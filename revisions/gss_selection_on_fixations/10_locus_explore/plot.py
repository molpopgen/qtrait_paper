...
distanceaxes.append(plt.subplot(
    gs[1, 4], sharex=distanceaxes[0], sharey=distanceaxes[0]))
...
freqaxes_notfixed.append(plt.subplot(
    gs[0, 3], sharex=freqaxes[0], sharey=freqaxes[0]))
freqaxes_notfixed.append(plt.subplot(
    gs[0, 5], sharex=freqaxes[0], sharey=freqaxes[0]))

distanceaxes_notfixed.append(plt.subplot(gs[1, 1], sharey=distanceaxes[0]))
distanceaxes_notfixed.append(plt.subplot(
    gs[1, 3], sharex=distanceaxes[0], sharey=distanceaxes[0]))
distanceaxes_notfixed.append(plt.subplot(
    gs[1, 5], sharex=distanceaxes[0], sharey=distanceaxes[0]))

saxes_notfixed.append(plt.subplot(gs[2, 1], sharey=saxes[0]))
saxes_notfixed.append(plt.subplot(gs[2, 3], sharex=saxes[0], sharey=saxes[0]))
saxes_notfixed.append(plt.subplot(gs[2, 5], sharex=saxes[0], sharey=saxes[0]))
...
for ax in freqaxes_notfixed + distanceaxes_notfixed:
...
for ax, m in zip(freqaxes, mu):
    ax.set_title(r'$\mu = $' + m + '\nfixations when '+r'$N\gamma^2 \geq 100$', fontdict={'fontsize': 14})
for ax, m in zip(freqaxes_notfixed, mu):
    ax.set_title(r'$\mu = $' + m + '\nlosses when ' +
                 r'$N\gamma^2 \geq 100$', fontdict={'fontsize': 14})
